...
<head>
    ...
    <script type="text/javascript">
        ...
        {
            var url = "<?php echo base_url(); ?>MentorController/PerfilUpdate";
            $.ajax(
            {                        
                type: "POST",                 
                url: url,                     
                ...
                success: function(data)             
                {
                    switch (data) {
                        case 'EXITO':
                            ...
                            window.location.href = "<?php echo base_url(); ?>MentorController/PerfilShow";
                            break;
                        case 'ERROR_ACTUALIZACION':
                            $("#respuesta").html('<div class="alert alert-danger" role="alert">Error en la actualización de los datos!</div>');
                            break;
                        default:
