...
<head>
    ...
    <script type="text/javascript">
        ...
        {
            var url = "<?php echo base_url(); ?>EmprendedorController/PerfilUpdate";
            $.ajax(
            {                        
                type: "POST",                 
                url: url,                     
                ...
                success: function(data)             
                {
                    switch (data) {
                        case 'EXITO':
                            ...
                            window.location.href = "<?php echo base_url(); ?>EmprendedorController/PerfilShow";
                            break;
                        case 'ERROR_ACTUALIZACION':
                            $("#respuesta").html('<div class="alert alert-danger" role="alert">Error en la actualización!</div>');
                            break;
                        default:
                            $("#respuesta").html('<div class="alert alert-danger" role="alert">Error en la validación!</div>');
                            break;
                    }
                }
            });
                                    ...
                                    <form name="form_profile" id="form_profile" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Usuario</label>
                                                    <?php echo '<input type="text" name="usuario" disabled="" class="form-control" placeholder="Company" value="'.$val->Usuario.'">'?>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <?php endforeach;?>
                                        <button class="btn btn-info btn-fill pull-right" type="button" name="siguiente" onclick="f_PerfilUpdate();">Actualizar</button>
