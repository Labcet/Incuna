                ...
                success: function(data)             
                {
                    switch (data) {
                        ...
                        case 'ERROR_INSERCION':
                            ...
                            break;
                        default:
                            $("#respuesta_nueva_convocatoria").html('<div class="alert alert-danger" role="alert">Error en la validación!<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
                            break;
                    }
                }
            });
                ...
                success: function(data)             
                {
                    switch (data) {
                        ...
                        case 'ERROR_ACTUALIZACION':
                            ...
                            break;
                        default:
                            $("#respuesta_actualizacion_convocatoria").html('<div class="alert alert-danger" role="alert">Error en la validación!<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
                            break;
                    }
                }
            });
