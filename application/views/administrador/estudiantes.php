...
<head>
    ...
    <script type="text/javascript">      
        ...
        window.onload = function() {
            ...
            $('#link_estudiantes').addClass("nav-item active");
        }

        function f_SaveEstudiante()
        {
            var url = "<?php echo base_url(); ?>/AdminController/SaveNewEstudiante";
            $.ajax(
            {                        
                type: "POST",                 
                url: url,                     
                ...
                success: function(data)             
                {
                    switch (data) {
                        case 'EXITO':
                            ...
                            window.location.href = "<?php echo base_url(); ?>AdminController/ShowEstudiantes";
                            break;
                        ...
                        case 'ERROR_EXISTENCIA':
                            $("#respuesta").html('<div class="alert alert-danger" role="alert">Ya existe un estudiante con ese usuario!<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
                            break;
                        default:
...
<body>
    ...
    <!-- Modal -->
    <div class="modal fade bd-example-modal-lg" id="nuevoEstudianteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form name="form_profile" id="form_profile" method="post">
                    ...
                    <input class="btn btn-info btn-fill pull-right" type="button" name="siguiente" value="Registrar" onclick="f_SaveEstudiante();">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            ...
                            <button type="button" class="btn btn-primary btn-fill" data-toggle="modal" data-target="#nuevoEstudianteModal">
                                Nuevo Estudiante
                            </button>
                            <br><br>
                            <div class="card">
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo '<a href="'.base_url("AdminController/DeleteEstudiante/".$row->Id).'"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="indianred" class="bi bi-trash-fill" viewBox="0 0 16 16">
