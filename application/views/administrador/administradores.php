...
<head>
    ...
    <script type="text/javascript">      
        ...
        window.onload = function() {
            ...
            $('#link_administradores').addClass("nav-item active");
        }

        function f_SaveAdministrador()
        {
            var url = "<?php echo base_url(); ?>/AdminController/SaveNewAdministrador";
            $.ajax(
            {                        
                type: "POST",                 
                url: url,                     
                ...
                success: function(data)             
                {
                    switch (data) {
                        case 'EXITO':
                            $("#respuesta").html('<div class="alert alert-success" role="alert">Registrado exitosamente!<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
                            window.location.href = "<?php echo base_url(); ?>AdminController/ShowAdministradores";
                            break;
                        case 'ERROR_INSERCION':
                            $("#respuesta").html('<div class="alert alert-danger" role="alert">Error al registrar!<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
                            break;
                        case 'ERROR_EXISTENCIA':
                            $("#respuesta").html('<div class="alert alert-danger" role="alert">Ya existe un administrador con ese usuario!<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
                            break;
                        default:
...
<body>
    ...
    <!-- Modal -->
    <div class="modal fade bd-example-modal-lg" id="nuevoAdministradorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Nuevo Administrador/Editor</h5>
                ...
                <form name="form_profile" id="form_profile" method="post">
                    ...
                    <button class="btn btn-info btn-fill pull-right" type="button" value="Registrar" onclick="f_SaveAdministrador();">Registrar</button>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            ...
                            <button type="button" class="btn btn-primary btn-fill" data-toggle="modal" data-target="#nuevoAdministradorModal">
                                Nuevo Administrador
                            </button>
                            <br><br>
                            <div class="card">
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo '<a href="'.base_url("AdminController/DeleteAdministrador/".$row->Id).'"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="indianred" class="bi bi-trash-fill" viewBox="0 0 16 16">
